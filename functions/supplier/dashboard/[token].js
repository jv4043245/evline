...
<html lang="ru">
  <head>
    ...
    <link rel="stylesheet" href="/supplier/supplier.css?v=20260626-no-supply-card-action">
    <script src="/supplier/supplier.js?v=20260626-no-supply-card-action" defer></script>
  </head>
