...
<html lang="zh-CN">
  <head>
    ...
    <title>EVLine · Supplier requests</title>
    <link rel="stylesheet" href="/supplier/supplier.css?v=20260628-supplier-i18n">
    <script src="/supplier/supplier.js?v=20260628-supplier-i18n" defer></script>
  </head>
  <body class="supplier-shell" data-supplier-page="dashboard" data-token="${safeToken}">
    <main class="supplier-app" data-app>
      <section class="supplier-loading">
        <span>EVLine · Supplier requests</span>
