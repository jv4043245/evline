...
export function publicSupplierBundle(bundle) {
  ...
  return {
    request: {
      ...
      request_text_cn: request.request_text_cn || request.request_text,
      supplier_note: request.manager_comment_cn || request.manager_comment,
      supplier_note_ru: request.manager_comment_ru || request.manager_comment,
      supplier_note_cn: request.manager_comment_cn || request.manager_comment,
...
function publicDashboardRequest(row, payment = null, bundle = null) {
  ...
  return {
    ...
    request_text_cn: row.request_text_cn || row.request_text,
    supplier_note: row.manager_comment_cn || row.manager_comment,
    supplier_note_ru: row.manager_comment_ru || row.manager_comment,
    supplier_note_cn: row.manager_comment_cn || row.manager_comment,
